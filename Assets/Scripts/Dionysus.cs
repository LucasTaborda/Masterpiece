...
public class Dionysus : MonoBehaviour
{
    ...
    private void InitializeDialogs()
    {
        ...
        dialogs.Add("ACT_3_SCENE_2", "El ladrón se abalanzó y alzó su espada para decapitarlo. Las nubes se cernían justo arriba de ellos. El príncipe suplicaba en el suelo.");
        ...
        dialogs.Add("ACT_4_SCENE_1", "Era el alba y el sol iluminaba la torre oeste.");
